---
title: window crypto (Oauth2 구현 시 고려)
tags: Oauth2
...
![](https://velog.velcdn.com/images/given/post/35c0b7a3-90dd-4345-8661-540f9cbc61f0/image.png)

window.crypto.subtle 이 없으면 발생하는 문제였다.

![](https://velog.velcdn.com/images/given/post/be3060c8-aced-4e30-9caf-5dbcb87c27ad/image.png)
