...
> [unbuntu node 세팅 참고](https://iter.kr/%EC%9A%B0%EB%B6%84%ED%88%AC-nvm-node-js-%EC%84%A4%EC%B9%98-%EC%84%A4%EC%A0%95/)
...
> 2,3번 참고한 [블로그](https://velog.io/@sargadi/AWS-EC2%EB%A1%9C-Next.js-%EB%B0%B0%ED%8F%AC%ED%95%98%EA%B8%B0)
...
> NginX와 HTTPS 세팅 잘 설명해준 [블로그](https://minsunblog.com/blog/feb5216bbc6642659a61a78a8af07db7)

> 참고로 [AWS가 아닌 외부 도메인 연결하는 법](https://rustywhite404.github.io/aws/2022/02/23/Aws-route53/) 그리고 [탄력 IP 받는 법과 연동 법](https://velog.io/@m1njae/AWS-%ED%83%84%EB%A0%A5%EC%A0%81-IP-%EC%A3%BC%EC%86%8C-%EC%84%A4%EC%A0%95)
