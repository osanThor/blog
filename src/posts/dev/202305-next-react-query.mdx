...
{<Blockquote type="info">Find the docs at https://tanstack.com/query/latest</Blockquote>}
...
{<Blockquote type="warn">**[2024]** - 나중에 클라이언트 providers 들은 따로 폴더로 빼서 관리했다.</Blockquote>}
